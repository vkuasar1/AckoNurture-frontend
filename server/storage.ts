...
export class MemStorage implements IStorage {
  ...
  private milestoneProgress: Map<string, MilestoneProgress>;
  ...
  constructor() {
    ...
    this.milestoneProgress = new Map();
  ...
  async createMilestoneProgress(
    ...
    const progress: MilestoneProgress = {
      id,
      babyId: insertProgress.babyId,
      milestoneDefId: insertProgress.milestoneDefId,
      completed: insertProgress.completed ?? false,
      completedAt: insertProgress.completedAt ?? null,
      completedWeek: insertProgress.completedWeek ?? null,
      timingStatus: insertProgress.timingStatus ?? null,
      badgeAwarded: insertProgress.badgeAwarded ?? false,
      badgeName: insertProgress.badgeName ?? null,
    };
    this.milestoneProgress.set(id, progress);
    return progress;
  }
  ...
  async upsertMilestoneProgress(
    ...
    return this.createMilestoneProgress({
      babyId,
      milestoneDefId,
      ...updates,
    } as InsertMilestoneProgress);
  }
