...
export const childPlanDetails = {
  digital: {
    ...
    shortDescription: "Includes AaI, tracking tools and more.",
    price: "₹999/year",
    benefits: [
...
export function getEffectiveChildPlan(
  plans: ActivePlans,
): ChildPlanType | "combo-digital" | "combo-essential" | "combo-premium" {
  if (plans.comboPlan) {
    return `combo-${plans.comboPlan}` as
      | "combo-digital"
      | "combo-essential"
      | "combo-premium";
  }
...
export function getEffectiveMotherPlan(
  plans: ActivePlans,
): MotherPlanType | "combo-digital" | "combo-essential" | "combo-premium" {
  if (plans.comboPlan) {
    return `combo-${plans.comboPlan}` as
      | "combo-digital"
      | "combo-essential"
