...
export const VACCINE_INFO: Record<string, VaccineInfo> = {
  BCG: {
    ...
    importance:
      "BCG is one of the most important vaccines given at birth. It protects your baby from severe forms of tuberculosis, especially TB meningitis which can be life-threatening in young children.",
  ...
  "Hepatitis B - Birth Dose": {
    ...
    importance:
      "Given within 24 hours of birth, this vaccine protects your baby from hepatitis B virus which can cause serious liver damage. Early protection is crucial!",
  ...
  "OPV - 0": {
    ...
    importance:
      "This oral vaccine given at birth is the first step in protecting your baby from polio, a disease that can cause permanent paralysis.",
  ...
  "DTwP/DTaP - 1": {
    ...
    importance:
      "This combination vaccine protects against three serious diseases in one shot, making it one of the most important vaccines in your baby's schedule.",
    protectsAgainst: [
      "Diphtheria",
      "Tetanus (Lockjaw)",
  ...
  "IPV - 1": {
    ...
    importance:
      "IPV works alongside OPV to provide complete protection against polio. It's especially important for building strong blood-based immunity.",
  ...
  "Hib - 1": {
    ...
    importance:
      "Hib vaccine protects against a bacteria that can cause meningitis, pneumonia, and other severe infections, especially dangerous for babies under 5.",
    protectsAgainst: [
      "Meningitis",
      "Pneumonia",
      "Epiglottitis",
    ...
    whenToSeekHelp: ["High fever", "Unusual irritability or drowsiness"],
    icon: "shield",
  },
  "Rotavirus - 1": {
    name: "Rotavirus",
    ...
    importance:
      "Rotavirus is the leading cause of severe diarrhea in babies. This oral vaccine prevents dehydration and hospitalizations from rotavirus infection.",
    protectsAgainst: [
    ...
    funFact:
      "Rotavirus vaccines have prevented millions of hospitalizations worldwide!",
    icon: "sparkles",
  },
  "PCV - 1": {
    name: "PCV",
    ...
    importance:
      "PCV protects against pneumococcal bacteria, a major cause of pneumonia, meningitis, and ear infections in young children.",
    protectsAgainst: [
      "Pneumonia",
      "Meningitis",
      "Ear infections",
  ...
  "MMR - 1": {
    ...
    importance:
      "MMR protects against three viral diseases that can cause serious complications. Given around 9-12 months when maternal antibodies fade.",
    ...
    funFact:
      "Measles vaccination has prevented over 21 million deaths since 2000!",
    icon: "star",
  },
  "Hepatitis A - 1": {
    name: "Hepatitis A",
    ...
    importance:
      "Hepatitis A spreads through contaminated food and water. This vaccine protects your growing child as they start eating varied foods.",
    ...
    whenToSeekHelp: ["Severe allergic reaction", "High persistent fever"],
    icon: "heart",
  },
  "Varicella - 1": {
    name: "Varicella",
    ...
    importance:
      "Chickenpox can cause severe complications in some children. The vaccine prevents the disease and its potential serious side effects.",
...
export const getVaccineInfo = (vaccineName: string): VaccineInfo => {
  ...
  return {
    ...
    importance:
      "This vaccine is part of the recommended immunization schedule to protect your baby from preventable diseases.",
