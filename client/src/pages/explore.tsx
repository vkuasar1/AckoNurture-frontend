    ...
    <div className="app-container bg-zinc-100 min-h-screen flex flex-col">
      ...
      <div className="bg-gradient-to-b from-[#1a1a1a] via-[#141414] to-[#0f0f0f] text-white px-4 pt-3 pb-5">
        ...
        <div className="flex items-center justify-between mb-5">
          <div className="flex items-center gap-3">
            ...
            <span className="text-[15px] font-medium" data-testid="text-greeting">Hey Aakash</span>
          </div>
          <Button 
            variant="outline"
            size="sm"
        ...
        <div className="flex gap-6 overflow-x-auto hide-scrollbar pb-1">
          ...
          >
            ...
            <span className="text-[11px] text-zinc-400 font-medium">Vehicles</span>
          </Button>
          ...
          >
            ...
            <span className="text-[11px] text-zinc-400 font-medium">Family</span>
          </Button>
          ...
          >
            ...
            <span className="text-[11px] text-zinc-400 font-medium">Policies</span>
          </Button>
          ...
          >
            ...
            <span className="text-[11px] text-zinc-400 font-medium">Rewards</span>
          </Button>
        </div>
        ...
        <Card className="mt-5 bg-gradient-to-r from-violet-700 via-violet-600 to-purple-600 border-0 rounded-2xl shadow-lg shadow-violet-900/30">
          <CardContent className="p-4 flex items-center justify-between">
            <div className="flex-1">
              <p className="text-[11px] text-violet-200 font-medium mb-0.5">Acko Health Plan</p>
              <p className="text-[14px] font-bold text-white leading-tight">Get your family health e-cards</p>
              <p className="text-[11px] text-violet-200 mt-0.5">Limited time only</p>
            </div>
            <Button 
      ...
      <div className="flex-1 bg-white rounded-t-[28px] -mt-3 overflow-y-auto pb-24 shadow-[0_-4px_20px_rgba(0,0,0,0.08)]">
        ...
        <div className="px-4 pt-6 pb-4">
          <h2 className="text-[20px] font-bold text-zinc-900 mb-4" data-testid="text-section-insurance">
            Buy insurance
          </h2>
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <Card className="col-span-1 row-span-2 border border-zinc-100 shadow-sm rounded-2xl relative">
              <CardContent className="p-4 h-full">
                ...
                <h3 className="text-[16px] font-bold text-zinc-900 mb-0.5">Car</h3>
                <p className="text-[12px] text-zinc-500 mb-2">Get your policy instantly</p>
                <Badge variant="secondary" className="bg-violet-100 text-violet-700 hover:bg-violet-100 text-[11px] font-semibold px-2.5 py-1 rounded-full">
                  Zero commission
                </Badge>
                <div className="absolute bottom-4 right-3 w-24 h-16">
                  <div className="w-full h-full bg-gradient-to-br from-slate-200 via-slate-100 to-white rounded-lg flex items-center justify-center shadow-inner">
                    <Car className="w-12 h-12 text-zinc-500" strokeWidth={1.5} />
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="border border-zinc-100 shadow-sm rounded-2xl">
              <CardContent className="p-3.5 flex items-center gap-2">
                <div className="flex-1 min-w-0">
                  <h3 className="text-[14px] font-bold text-zinc-900 mb-0.5 leading-tight">Brand new car?</h3>
                  <p className="text-[12px] text-zinc-500">Save up to {"\u20B9"}36,000</p>
                </div>
            ...
            <Card className="border border-zinc-100 shadow-sm rounded-2xl">
              <CardContent className="p-3.5 flex items-center gap-2">
                <div className="flex-1 min-w-0">
                  <h3 className="text-[14px] font-bold text-zinc-900 mb-0.5 leading-tight">Bike & Scooter</h3>
                  <p className="text-[12px] text-zinc-500">Starts at just {"\u20B9"}112</p>
                </div>
            ...
            <Card className="border border-zinc-100 shadow-sm rounded-2xl relative">
              <CardContent className="p-3.5">
                <h3 className="text-[14px] font-bold text-zinc-900 mb-0.5">Health</h3>
                <p className="text-[12px] text-zinc-500 mb-1.5">100% bill coverage</p>
                <Badge variant="secondary" className="bg-violet-100 text-violet-700 hover:bg-violet-100 text-[10px] font-semibold px-2 py-0.5 rounded-full">
                  0% GST
                </Badge>
                <div className="absolute bottom-2.5 right-2.5 w-12 h-12">
                  <div className="w-full h-full bg-gradient-to-br from-pink-100 to-rose-50 rounded-lg flex items-center justify-center shadow-inner">
                    <Building2 className="w-7 h-7 text-pink-500" strokeWidth={1.5} />
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="border border-zinc-100 shadow-sm rounded-2xl relative">
              <CardContent className="p-3.5">
                <h3 className="text-[14px] font-bold text-zinc-900 mb-0.5">Travel</h3>
                <Badge variant="secondary" className="bg-emerald-100 text-emerald-700 hover:bg-emerald-100 text-[10px] font-semibold px-2 py-0.5 rounded-full">
                  Get AirPass
                </Badge>
                <div className="absolute bottom-2.5 right-2.5 w-12 h-12">
                  <div className="w-full h-full bg-gradient-to-br from-indigo-100 to-blue-50 rounded-lg flex items-center justify-center shadow-inner">
                    <Plane className="w-7 h-7 text-indigo-500 rotate-45" strokeWidth={1.5} />
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="border border-zinc-100 shadow-sm rounded-2xl relative">
              <CardContent className="p-3.5">
                <h3 className="text-[14px] font-bold text-zinc-900 mb-0.5">Life</h3>
                <Badge variant="secondary" className="bg-violet-100 text-violet-700 hover:bg-violet-100 text-[10px] font-semibold px-2 py-0.5 rounded-full">
                  0% GST
                </Badge>
                <div className="absolute bottom-2.5 right-2.5 w-12 h-12">
                  <div className="w-full h-full bg-gradient-to-br from-purple-100 to-violet-50 rounded-lg flex items-center justify-center shadow-inner">
                    <Umbrella className="w-7 h-7 text-purple-500" strokeWidth={1.5} />
                  </div>
                </div>
              </CardContent>
            </Card>
        ...
        <div className="px-4 pb-5">
          <h2 className="text-[20px] font-bold text-zinc-900 mb-4" data-testid="text-section-domore">
            Do more with ACKO
          </h2>

          {/* Nurture - Featured Card */}
          <Link href="/babycare">
            <Card className="bg-gradient-to-br from-pink-50 via-violet-50 to-white border border-pink-100 shadow-md rounded-2xl mb-4 cursor-pointer hover:shadow-lg transition-shadow" data-testid="card-featured-nurture">
          ...
          <div className="grid grid-cols-3 gap-2.5">
            ...
            <Card className="border border-zinc-100 shadow-sm rounded-2xl">
              <CardContent className="p-3 flex flex-col items-center text-center min-h-[95px]">
                ...
                <h4 className="text-[11px] font-semibold text-zinc-900 leading-tight">Pay traffic<br/>challans</h4>
              </CardContent>
            </Card>
            ...
            <Card className="border border-zinc-100 shadow-sm rounded-2xl">
              <CardContent className="p-3 flex flex-col items-center text-center min-h-[95px]">
                ...
                <h4 className="text-[11px] font-semibold text-zinc-900 leading-tight">Check resale<br/>value</h4>
              </CardContent>
            </Card>
            ...
            <Card className="border border-zinc-100 shadow-sm rounded-2xl">
              <CardContent className="p-3 flex flex-col items-center text-center min-h-[95px]">
                ...
                <h4 className="text-[11px] font-semibold text-zinc-900 leading-tight">Book car<br/>service</h4>
              </CardContent>
            </Card>
            ...
            <Card className="border border-zinc-100 shadow-sm rounded-2xl">
              <CardContent className="p-3 flex flex-col items-center text-center min-h-[95px]">
                ...
                <h4 className="text-[11px] font-semibold text-zinc-900 leading-tight">Get vehicle<br/>info</h4>
              </CardContent>
            </Card>
            ...
            <Card className="border border-zinc-100 shadow-sm rounded-2xl">
              <CardContent className="p-3 flex flex-col items-center text-center min-h-[95px]">
                ...
                <h4 className="text-[11px] font-semibold text-zinc-900 leading-tight">Get ABHA<br/>card</h4>
              </CardContent>
            </Card>

            {/* Nurture - Tile */}
            <Link href="/babycare">
              <Card className="border border-pink-100 shadow-sm rounded-2xl cursor-pointer hover:shadow-md transition-shadow bg-gradient-to-br from-pink-50/50 to-violet-50/50" data-testid="card-utility-nurture">
                <CardContent className="p-3 flex flex-col items-center text-center min-h-[95px]">
                  ...
                  <h4 className="text-[11px] font-semibold text-zinc-900 leading-tight">Nurture</h4>
                  <p className="text-[9px] text-zinc-500 mt-0.5 leading-tight">Mom & baby care</p>
                </CardContent>
              </Card>
            </Link>
            ...
            <Card className="border border-zinc-100 shadow-sm rounded-2xl">
              <CardContent className="p-3 flex flex-col items-center text-center min-h-[95px]">
                ...
                <h4 className="text-[11px] font-semibold text-zinc-900 leading-tight">Discover<br/>all</h4>
              </CardContent>
            </Card>
          </div>
        </div>
        ...
        <div className="px-4 pb-5">
          <h2 className="text-[20px] font-bold text-zinc-900 mb-4" data-testid="text-section-ownership">
          ...
          <div className="grid grid-cols-2 gap-3">
            <Card className="border border-zinc-100 shadow-sm rounded-2xl">
              <CardContent className="p-4">
                <h3 className="text-[14px] font-bold text-zinc-900 mb-1 leading-tight">Servicing at<br/>any garage</h3>
                <Badge variant="secondary" className="bg-violet-100 text-violet-700 hover:bg-violet-100 text-[10px] font-semibold px-2 py-0.5 rounded-full">
                  Free pickup & drop
                </Badge>
                <div className="mt-6 flex justify-end">
                  <Button variant="outline" size="icon" className="w-8 h-8 rounded-full border-zinc-200">
            ...
            <Card className="border border-zinc-100 shadow-sm rounded-2xl">
              <CardContent className="p-4">
                <h3 className="text-[14px] font-bold text-zinc-900 mb-1 leading-tight">Explore your<br/>next car</h3>
                <Badge variant="secondary" className="bg-violet-100 text-violet-700 hover:bg-violet-100 text-[10px] font-semibold px-2 py-0.5 rounded-full">
                  10,000+ cars
                </Badge>
                <div className="mt-6 flex justify-end">
        ...
        <div className="px-4 pb-5">
          <h2 className="text-[20px] font-bold text-zinc-900 mb-4" data-testid="text-section-spotlight">
            In the spotlight
          </h2>
              ...
              <Card className="min-w-[280px] bg-gradient-to-br from-sky-100 via-cyan-50 to-white border-0 shadow-md rounded-2xl relative overflow-hidden">
                <CardContent className="p-5">
                  <h3 className="text-[18px] font-bold text-zinc-900 mb-1 leading-tight">
                    Get up to {"\u20B9"}600 OFF<br/>on car insurance
                  </h3>
                  <p className="text-[12px] text-zinc-600 mb-4">Use coupons for more savings</p>
                  <Button 
                    className="bg-white text-zinc-900 hover:bg-zinc-50 rounded-full px-4 h-9 text-[13px] font-semibold gap-1.5 shadow-sm border border-zinc-200"
                  >
                    Insure now <ArrowRight className="w-4 h-4" />
                  </Button>
                  <div className="absolute -right-4 -bottom-4 w-28 h-28 opacity-20">
                    <Car className="w-full h-full text-cyan-500" strokeWidth={0.5} />
                  </div>
                </CardContent>
              </Card>
            </div>
        ...
        <div className="px-4 py-10 text-center bg-gradient-to-b from-white via-violet-50/50 to-violet-100/30">
          ...
          <p className="text-[20px] font-bold text-zinc-900">for millions of Indians</p>
        </div>
      </div>
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-zinc-200 max-w-md mx-auto">
        <div className="flex items-center justify-around py-2 px-4">
          ...
          >
            ...
            <span className="text-[11px] font-semibold text-violet-600">Explore</span>
          </Button>
          ...
          >
            ...
            <span className="text-[11px] font-medium text-zinc-500">Support</span>
          </Button>
        </div>
      </div>
    </div>
