  ...
  return (
    <div className="app-container bg-zinc-50 min-h-screen flex flex-col relative">
      ...
      <div className="flex-1 overflow-y-auto pb-32 px-4 pt-4">
        ...
        {/* AI Nanny Card - Medical Questions */}
        <Card className="bg-gradient-to-r from-indigo-50 to-violet-50 border border-indigo-100 rounded-2xl mt-6 overflow-hidden" data-testid="card-ai-nanny-medical">
          <CardContent className="p-4">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div className="flex-1">
                <p className="text-[14px] font-bold text-indigo-900 mb-0.5">
                  Health questions?
                </p>
                <p className="text-[11px] text-indigo-600">
                  Ask AI Nanny about your baby's medical care
                </p>
              </div>
            </div>
            ...
            <div className="space-y-2 mb-4">
              <p className="text-[11px] font-semibold text-indigo-500 uppercase tracking-wide">Try asking:</p>
              <div className="flex flex-wrap gap-2">
                <span className="text-[11px] bg-white text-indigo-700 px-3 py-1.5 rounded-full border border-indigo-200">
            ...
            <Link href={`/babycare/ai-nanny/${babyId}`}>
              <Button 
                className="w-full bg-gradient-to-r from-indigo-500 to-violet-600 hover:opacity-90 text-white rounded-xl shadow-md h-11 font-semibold gap-2"
                data-testid="button-ask-ai-nanny-medical"
              >
