...
const ANONYMOUS_NAMES = [
  "Caring Parent", "Hopeful Heart", "Gentle Soul", "Warm Spirit", 
  "Kind Mind", "Tender Heart", "Loving Parent", "Peaceful Mind",
  "Bright Hope", "Calm Spirit", "Sweet Soul", "Wise Heart"
];

const ANONYMOUS_MENTOR_NAMES = [
  "Supportive Guide", "Caring Mentor", "Experienced Parent", "Gentle Advisor"
];
...
function getRandomMentorName(): string {
  return ANONYMOUS_MENTOR_NAMES[Math.floor(Math.random() * ANONYMOUS_MENTOR_NAMES.length)];
}

type FlowStep = "describe" | "choose" | "mentors" | "schedule" | "payment" | "confirmation" | "community";
...
const PARENT_MENTORS: ParentMentor[] = [
  {
    ...
    name: "Priya Sharma",
    avatar: "",
    specialty: ["Developmental Milestones", "Sleep Training", "First-time Parenting"],
    rating: 4.9,
    reviews: 127,
    ...
    availability: ["Today 4:00 PM", "Today 6:00 PM", "Tomorrow 10:00 AM", "Tomorrow 2:00 PM"]
  },
  {
    id: "mentor-2",
    name: "Anjali Reddy",
  ...
  },
  {
    ...
    name: "Meera Kapoor",
    avatar: "",
    specialty: ["Speech & Communication", "Social Development", "Autism Awareness"],
    rating: 5.0,
    reviews: 64,
  ...
  },
  {
    ...
    name: "Sneha Iyer",
    avatar: "",
    specialty: ["Cognitive Development", "Play-based Learning", "Anxiety Management"],
    rating: 4.7,
    reviews: 156,
...
const INITIAL_COMMUNITY_MESSAGES: CommunityMessage[] = [
  {
    ...
    author: "Ritu M.",
    avatar: "",
    content: "Welcome to the milestone support group! Feel free to share your concerns. We're all in this together.",
    time: "Pinned"
  },
  {
    id: "msg-2",
    author: "Kavita S.",
    avatar: "",
    content: "My 4-month-old just started recognizing voices yesterday! Keep the faith, mamas!",
    time: "2 hours ago"
  },
  {
    id: "msg-3",
    author: "Deepa R.",
    avatar: "",
    content: "Anyone else's baby taking longer with social smiling? My pediatrician said it's normal but I can't help worrying.",
    time: "3 hours ago"
  }
];
...
export default function ParentCommunity() {
  ...
  const [selectedMentor, setSelectedMentor] = useState<ParentMentor | null>(null);
  ...
  const handleSendMessage = () => {
    ...
    setTimeout(() => {
      ...
      setCommunityMessages(prev => [...prev, {
        ...
        author: replyName,
        avatar: "",
        content: "I totally understand how you feel! My little one was the same. Hang in there!",
        time: "Just now"
      }]);
    }, 2000);
  };
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex-1">
            <h1 className="text-[16px] font-bold">
              {step === "community" ? "Parent Community" : "Connect with Parents"}
            </h1>
            <p className="text-[11px] text-purple-200">
              {step === "community" ? "Share, learn, grow together" : "You're not alone in this journey"}
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="flex-1 overflow-y-auto">
        <AnimatePresence mode="wait">
          {step === "describe" && (
            ...
            >
              <div className="text-center mb-6">
                ...
                <h2 className="text-[18px] font-bold text-zinc-900">We're here for you</h2>
              ...
              <Card className="border-purple-100">
                <CardContent className="p-4">
                  ...
                  <p className="text-[11px] text-zinc-400 mt-2">
                    This helps us connect you with the right parents and community
                  </p>
                </CardContent>
              </Card>

              <div className="mt-4 space-y-2">
                <p className="text-[12px] font-medium text-zinc-600">Quick topics:</p>
                <div className="flex flex-wrap gap-2">
                  {["Delayed milestones", "Sleep concerns", "Feeding issues", "Social development"].map((topic) => (
                    <button
                      key={topic}
                      onClick={() => setConcern(prev => prev ? `${prev} ${topic}` : topic)}
              ...
              <div className="flex items-center justify-between mt-6 mb-3">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-[13px] font-medium text-zinc-700">Go anonymous</span>
                </div>
                <Switch
                  checked={isAnonymous}
          ...
          {step === "choose" && (
            ...
            >
              <div className="text-center mb-6">
                ...
                <h2 className="text-[18px] font-bold text-zinc-900">How would you like to connect?</h2>
                <p className="text-[13px] text-zinc-500 mt-2">
                  ...
                  <Card className="border-purple-200 hover:border-purple-400 hover:shadow-md transition-all">
                    <CardContent className="p-4">
                      <div className="flex items-start gap-4">
                        <div className="w-12 h-12 bg-gradient-to-br from-purple-500 to-purple-600 rounded-xl flex items-center justify-center flex-shrink-0">
                          {isAnonymous ? <Phone className="w-6 h-6 text-white" /> : <Video className="w-6 h-6 text-white" />}
                        </div>
                        <div className="flex-1">
                          <div className="flex items-center gap-2">
                            <h3 className="text-[15px] font-semibold text-zinc-900">
                              {isAnonymous ? "1:1 Voice Call" : "1:1 Video Call"}
                            </h3>
                            {isAnonymous && (
                              <Badge variant="secondary" className="text-[9px] bg-purple-100 text-purple-700">Anonymous</Badge>
                            )}
                          </div>
                  ...
                  <Card className="border-emerald-200 hover:border-emerald-400 hover:shadow-md transition-all">
                    <CardContent className="p-4">
                      <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1">
                          <div className="flex items-center gap-2">
                            <h3 className="text-[15px] font-semibold text-zinc-900">Community Chat</h3>
                            <Badge variant="secondary" className="text-[9px] bg-emerald-100 text-emerald-700">Free</Badge>
                          </div>
                          <p className="text-[12px] text-zinc-500 mt-1">
                            Join our supportive community of parents going through similar journeys
                          </p>
                          <div className="flex items-center gap-3 mt-2">
                            <div className="flex items-center gap-1 text-[11px] text-zinc-400">
              ...
              <div className="mt-6 p-4 bg-purple-50 rounded-xl">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-[12px] font-medium text-purple-800">Safe & Supportive Space</p>
                    <p className="text-[11px] text-purple-600 mt-0.5">
                      All our parent mentors are verified and our community is moderated 24/7
                    </p>
                  </div>
                </div>
              </div>
          ...
          {step === "mentors" && (
            ...
            >
              <div className="mb-4">
                <h2 className="text-[16px] font-bold text-zinc-900">Parent Mentors</h2>
                <p className="text-[12px] text-zinc-500 mt-1">
                        ...
                        <div className="flex items-start gap-3">
                          ...
                          <div className="flex-1 min-w-0">
                            <div className="flex items-center justify-between">
                              <h3 className="text-[14px] font-semibold text-zinc-900">{mentor.name}</h3>
                              <div className="flex items-center gap-1">
                                <Star className="w-3.5 h-3.5 text-amber-500 fill-amber-500" />
                                <span className="text-[12px] font-medium text-zinc-700">{mentor.rating}</span>
                                <span className="text-[11px] text-zinc-400">({mentor.reviews})</span>
                              </div>
                            </div>
                            <p className="text-[11px] text-zinc-500 mt-0.5">{mentor.experience}</p>
                            <div className="flex flex-wrap gap-1 mt-2">
                              {mentor.specialty.slice(0, 2).map((s) => (
                                <span key={s} className="px-2 py-0.5 bg-purple-50 text-purple-600 rounded-full text-[10px]">
                                  {s}
                                </span>
                              ))}
                            </div>
              ...
              <Card className="border-purple-200 mb-4">
                <CardContent className="p-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h3 className="text-[15px] font-semibold text-zinc-900">{selectedMentor.name}</h3>
                      <div className="flex items-center gap-1 mt-0.5">
                        <Star className="w-3.5 h-3.5 text-amber-500 fill-amber-500" />
                        <span className="text-[12px] text-zinc-600">{selectedMentor.rating} ({selectedMentor.reviews} reviews)</span>
                      </div>
                    </div>
                  </div>
                  <p className="text-[12px] text-zinc-600 mt-3 italic">"{selectedMentor.bio}"</p>
                </CardContent>
              </Card>

              <div className="mb-4">
                <h2 className="text-[16px] font-bold text-zinc-900">Select a time slot</h2>
                <p className="text-[12px] text-zinc-500 mt-1">30-minute video session</p>
              </div>
                ...
                {selectedMentor.availability.map((slot) => (
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <span className="text-[14px] font-medium text-zinc-800">{slot}</span>
                    </div>
                    {selectedSlot === slot && (
          ...
          {step === "payment" && selectedMentor && selectedSlot && (
            ...
            >
              <div className="mb-6">
                <h2 className="text-[16px] font-bold text-zinc-900">Confirm & Pay</h2>
                <p className="text-[12px] text-zinc-500 mt-1">Secure payment powered by Acko</p>
              </div>

              <Card className="border-zinc-200 mb-4">
                <CardContent className="p-4 space-y-3">
                  <div className="flex items-center justify-between">
                    <span className="text-[13px] text-zinc-600">Session with</span>
                    <span className="text-[13px] font-medium text-zinc-900">{selectedMentor.name}</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-[13px] text-zinc-600">Date & Time</span>
                    <span className="text-[13px] font-medium text-zinc-900">{selectedSlot}</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-[13px] text-zinc-600">Duration</span>
                    <span className="text-[13px] font-medium text-zinc-900">30 minutes</span>
                  </div>
                </CardContent>
              </Card>
          ...
          {step === "confirmation" && selectedMentor && selectedSlot && (
            ...
            >
              ...
              <h2 className="text-[20px] font-bold text-zinc-900 text-center">You're all set!</h2>
              ...
              <Card className="border-purple-200 mt-6 w-full">
                <CardContent className="p-4 text-center">
                  <div className="flex items-center justify-center gap-2 text-purple-600">
                    ...
                    <span className="text-[15px] font-semibold">{selectedSlot}</span>
                  </div>
              ...
              <div className="mt-6 p-4 bg-amber-50 rounded-xl w-full">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-[12px] font-medium text-amber-800">Prepare for your call</p>
                    <p className="text-[11px] text-amber-600 mt-0.5">
                      Write down any specific questions you'd like to ask. {selectedMentor.name} is here to help!
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="p-3 bg-purple-50 border-b border-purple-100">
                <div className="flex items-center gap-2">
                  <div className="flex -space-x-2">
                    {[1, 2, 3].map((i) => (
                      <div key={i} className="w-6 h-6 bg-gradient-to-br from-purple-400 to-pink-400 rounded-full border-2 border-white" />
                    ))}
                  </div>
              ...
              <div className="flex-1 overflow-y-auto p-4 space-y-4">
                {communityMessages.map((msg) => (
                  ...
                  >
                    ...
                    <div className={`flex-1 max-w-[80%] ${msg.isCurrentUser ? 'text-right' : ''}`}>
                      <div className="flex items-center gap-2 mb-1">
                        {!msg.isCurrentUser && (
                          <span className="text-[12px] font-medium text-zinc-700">{msg.author}</span>
                        )}
