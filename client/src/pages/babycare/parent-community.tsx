                  ...
                  <Card className="border-purple-200 hover:border-purple-400 hover:shadow-md transition-all">
                    <CardContent className="p-4">
                      <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1">
                          <div className="flex items-center gap-2">
                            <h3 className="text-[15px] font-semibold text-zinc-900">1:1 Video Call</h3>
                            <Badge variant="secondary" className="text-[9px] bg-amber-100 text-amber-700">Premium</Badge>
                          </div>
            ...
            >
              ...
              <Card className="border-zinc-200 mb-4">
                <CardContent className="p-4 space-y-3">
                  ...
                  <div className="border-t border-zinc-100 pt-3 flex items-center justify-between">
                    ...
                    <span className="text-[16px] font-bold text-purple-600">Rs. {selectedMentor.pricePerSession}</span>
                  </div>
                </CardContent>
              </Card>
              ...
              >
                {isProcessingPayment ? (
                  ...
                  <>Pay Rs. {selectedMentor.pricePerSession}</>
                )}
              </Button>
