...
export default function NannyDashboardPage() {
  ...
  const getHelpTitle = () => {
    switch (helpAction) {
      case "not-arrived":
        return "Report: Nanny Didn't Arrive";
      case "safety":
        return "Report Safety Concern";
      case "replacement":
      ...
      <div className="app-container min-h-screen bg-zinc-50 flex items-center justify-center">
        <div className="text-center p-4">
          <p className="text-[14px] text-zinc-500 mb-4">
            No active nanny booking found
          </p>
          <Button
            onClick={() => navigate(`/babycare/nanny/${babyId}`)}
            data-testid="button-find-nanny"
          >
            Find a Nanny
          </Button>
        </div>
  ...
  return (
    <div className="app-container min-h-screen bg-zinc-50 flex flex-col">
            ...
            <CardContent className="p-4">
              ...
              <div className="space-y-2">
                {mockAttendance.map((day, index) => (
                  ...
                  >
                    <div className="flex items-center gap-3">
                      <span className="text-[12px] text-zinc-500 w-12">
                        {day.day}
                      </span>
      ...
      <Dialog
        open={showHelpDialog && !showConfirmation}
