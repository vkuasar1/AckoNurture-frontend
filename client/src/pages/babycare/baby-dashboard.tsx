...
export default function BabyDashboard() {
  ...
  const babyAge = baby
    ? calculateAge(baby.dob as string)
    : { display: "", months: 0, days: 0 };
  ...
  return (
    <div className="app-container bg-zinc-50 min-h-screen flex flex-col relative">
        ...
        >
          <div className="flex items-center gap-4">
            ...
            <div className="flex-1 min-w-0">
              <h2
                className="text-[20px] font-bold text-white mb-2 truncate"
                data-testid="text-baby-name"
              >
                {baby.name}
              </h2>
      ...
      <div className="flex-1 overflow-y-auto pb-24 px-4 pt-3">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-[12px] text-white/80">
                      Get AaI, expert consultations & more
                    </p>
                  </div>
        ...
        <Card
          className="bg-white border border-zinc-100 shadow-md rounded-2xl overflow-hidden mb-3"
        ...
        >
          <CardContent className="p-0">
            <div className="bg-gradient-to-r from-amber-400 via-orange-400 to-yellow-400 px-4 py-4 flex items-center justify-between">
              ...
              <Link
                href={`/babycare/milestones/${babyProfileId}`}
                data-testid="link-milestones-view-all"
              >
                <Button
                  size="sm"
                  variant="secondary"
                  className="bg-white/25 hover:bg-white/35 text-white border-0 text-[11px] h-8 font-semibold"
                >
        ...
        <div className="grid grid-cols-2 gap-3 mb-3">
          ...
          <button
            onClick={() =>
              toast({
                title: "Coming Soon",
                description: "Nanny feature is being prepared for you!",
              })
            }
          ...
          <Link href="/babycare/plans">
            <Card
              className="bg-white border border-zinc-100 shadow-sm rounded-xl overflow-hidden hover-elevate"
              data-testid="card-wellness-plans"
            >
              <CardContent className="p-4 relative">
                ...
                {!userHasChildPlan && (
                  <span className="text-[11px] text-violet-600 font-semibold mt-1 block">
                    Explore
                  </span>
                )}
                {userHasChildPlan && (
